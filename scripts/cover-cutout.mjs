 ...
 *
 * `tg-3269-jpg` и `tg-3588-jpg` — оба флудовыпуска: девушка на велосипеде
 * у воды и токийская башня над крышей храма. ВЫРЕЗАТЬ ТАМ НЕЧЕГО, и об этом
 * прямо говорит замер: фигура заняла 93 % и 101 % рамки, то есть «фигурой»
 * оказался весь кадр целиком — обложка нарисована сценой, а не персонажем
 * на белом. Отметка «фигура крупная» тут не сомнение, а точный ответ.
 * Решение заказчика 12 августа 2026.
 */
const EXCLUDE = ['3a8d5148', 'tg-3269-jpg', 'tg-3588-jpg'];
