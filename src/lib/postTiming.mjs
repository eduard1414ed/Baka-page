...
// только обложка, название и описание, а дальше пост будет закрыт всплывающим
// окном с призывом подписаться. Длительности у нас нет (бонусов нет
// в публичном RSS), а время чтения посчиталось бы по тизеру, за которым текста
// всё равно не будет, — то есть врало бы читателю прямо в лицо.
