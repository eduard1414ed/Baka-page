...
const posts = defineCollection({
	...
	schema: () =>
		z.object({
			...
			//
			// ОБА ПОЛЯ НЕОБЯЗАТЕЛЬНЫЕ, И ЭТО НАРОЧНО. CMS пишет пустую строку,
			// а не пропускает поле; строгая схема уронила бы сборку ВСЕГО сайта
			// от одной недозаполненной строки списка. Мусор отсеивает и говорит
			// о нём в лог TimecodeList.astro — ломаться надо громко, но не всем
			// сайтом сразу.
			timecodes: z
				.array(
					z.object({
